...
exports.getAllInternshipApplicationsByStudentId = async function (req, res) {
  let internshipapplication = new InternshipApplication()
  let internshipapplications = await internshipapplication.getAllInternshipApplicationsByStudentId(req.params.id)
  new JsonResponse(req, res).jsonSuccess(internshipapplications, new Messages().SUCCESSFULLY_RECEIVED)
  return internshipapplications
}
